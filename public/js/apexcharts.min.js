(self["webpackChunk"] = self["webpackChunk"] || []).push([["/js/apexcharts.min"],{
  ...
  var A = {
    ...
    return a(t, [{
      ...
      value: function value(t, e, i) {
        ...
        var o = Math.abs(i - e);
        if (r.logarithmic && o <= 5 && (a.invalidLogScale = !0), r.logarithmic && o > 5) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(i, r.logBase);else if (i !== -Number.MAX_VALUE && f.isNumber(i)) {
...
/******/ var __webpack_exports__ = (__webpack_exec__("./resources/libs/apexcharts/dist/apexcharts.min.js"));
/******/ }
]);